...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/megaman.png", NME_assets_megaman_png);
			resourceTypes.set ("assets/megaman.png", "image");
			resourceClasses.set ("assets/hero_0.png", NME_assets_hero_0_png);
			resourceTypes.set ("assets/hero_0.png", "image");
